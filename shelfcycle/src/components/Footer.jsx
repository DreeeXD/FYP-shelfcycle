...
const Footer = () => {
  return (
    <footer className="bg-white text-gray-800 py-10 border-t border-blue-200">
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-start gap-10">
        
        {/* Branding */}
        <div className="flex-1">
          <h2 className="text-3xl font-extrabold text-blue-600 mb-3">ShelfCycle</h2>
        ...
        <div className="flex-1">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            ...
            <li><a href="/exchanges" className="hover:text-blue-700 transition">Exchanges</a></li>
            <li><a href="/chat" className="hover:text-blue-700 transition">Chat</a></li>
            <li><a href="/signup" className="hover:text-blue-700 transition">Register</a></li>
          </ul>
        </div>

        {/* Contact & Socials */}
        <div className="flex-1">
          <h3 className="text-lg font-semibold mb-4 text-blue-600">Stay Connected</h3>
          <p className="text-sm text-gray-600 mb-3">Follow us on social media</p>
          <div className="flex gap-4 text-xl">
            <a href="#" className="text-blue-500 hover:text-blue-700 transition"><FaFacebookF /></a>
      ...
      <div className="mt-10 border-t border-indigo-100 pt-4 text-center text-sm text-gray-500">
        &copy; {new Date().getFullYear()} <span className="font-medium text-blue-600">ShelfCycle</span>. All rights reserved.
      </div>
    </footer>
  );
};
