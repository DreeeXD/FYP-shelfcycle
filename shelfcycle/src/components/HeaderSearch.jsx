  ...
  return (
    <form onSubmit={handleSubmit} className="relative w-[300px] hidden lg:flex" ref={dropdownRef}>
      <input
        ...
        className="flex-1 border px-3 py-1 rounded-full shadow-sm focus:outline-none text-sm text-gray-700"
      />
      ...
      {showDropdown && suggestions.length > 0 && (
        <div className="absolute top-10 left-0 w-full bg-white border rounded shadow z-50">
          {suggestions.map(book => (
            <div
              key={book._id}
              className="px-4 py-2 text-sm cursor-pointer hover:bg-blue-100 truncate"
